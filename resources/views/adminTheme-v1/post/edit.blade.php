...
@section('content')
  <div class="content-wrapper">
    ...
    <section class="content">
      {!! Form::model($post, ['route' => ['post.update', $post->slug], 'method' => 'PUT']) !!}
      <div class="row">
        <div class="col-md-9">
          <div class="row">
            <div class="col-md-12">
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title"><i class="fa fa-edit"></i> Edit Postingan</h3>
                </div>
                <div class="box-body">
                ...
                <div class="box-body">
                  ...
                  <div class="form-group {{ $errors->has('is_publish') ? 'has-error':'' }}">
                    ...
                    <select class="form-control" name="is_publish" required="" id="is_publish">
                      <option value="1" {{ $post->is_publish == 1 ? 'selected':'' }}>Aktif</option>
              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                  ...
                  <div class="form-group {{ $errors->has('tag') ? 'has-error':'' }}">
                    <label>Tag</label>
                    {!! Form::text('tag', $implodeTag, ['class' => 'form-control', 'id' => 'tag', 'placeholder' => 'Pisahkan dengan koma']) !!}
