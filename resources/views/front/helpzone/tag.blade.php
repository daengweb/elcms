...
@section('title')
    <title>{{ ucfirst($tag->nama_tag) }} - {{ $site_title }}</title>
    ...
    <meta property="og:title" content="{{ $tag->nama_tag }} - {{ $site_title }}"/>
    ...
    <meta name="twitter:title" content="{{ $tag->nama_tag }} - {{ $site_title }}" />
...
@section('content')
    <section class="page-title" data-parallax="scroll">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <h1 class="headkatag">{{ ucfirst($tag->nama_tag) }}</h1>
                </div>
            </div>
        </div>
    </section>
